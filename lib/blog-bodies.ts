...
export const postBodies: Record<PostSlug, string> = {
  "opcoes-binarias": `
<p class="post-lede">Se você está entrando no mundo dos <strong>investimentos</strong> e já ouviu falar em <strong>opções binárias</strong>, mas ainda não sabe exatamente o que são ou como funcionam, este artigo é para você — claro, objetivo e sem enrolação.</p>
...
<aside class="post-note">
  ...
  <dl class="post-defs">
    <div><dt>CALL</dt><dd>você opera a alta</dd></div>
    <div><dt>PUT</dt><dd>você opera a queda</dd></div>
    <div><dt>Payout</dt><dd>percentual de retorno sobre o valor investido em caso de acerto</dd></div>
    <div><dt>Expiração</dt><dd>tempo até o resultado da operação</dd></div>
  </dl>
</aside>
<h2>Quais ativos posso operar?</h2>
<p>Na <a href="${home}">Shiver Broker</a> você opera mais de 392 ativos, incluindo:</p>
<ul>
  <li><strong>Pares de moedas (Forex)</strong> — EUR/USD, GBP/BRL e outros</li>
  <li><strong>Criptomoedas</strong> — Bitcoin, Ethereum, Solana</li>
  <li><strong>Ações globais</strong> — Tesla, Apple, Amazon</li>
  <li><strong>Commodities</strong> — ouro, petróleo, prata</li>
  <li><strong>Índices</strong> — S&amp;P 500, Nasdaq, Ibovespa</li>
</ul>
...
`,
  confiavel: `
<p class="post-lede">Se você chegou até aqui, provavelmente está considerando abrir uma conta na <strong>Shiver Broker</strong> e quer ter certeza de que é uma plataforma segura antes de depositar. Essa é a pergunta certa — e a resposta precisa ser transparente.</p>
<h2>O que é a Shiver Broker?</h2>
<p>A Shiver Broker é uma corretora internacional de opções binárias, forex e ativos digitais, feita para traders que exigem performance, tecnologia e clareza.</p>
<p>A empresa é registrada como <strong>Sun Wave LLC</strong>, número L 22402. As transações financeiras são processadas pela <strong>S.W. SUN WAVE CY LTD</strong> (HE450991), em Limassol, Chipre.</p>
...
<aside class="post-note">
  ...
  <dl class="post-defs">
    <div><dt>AML/KYC</dt><dd><a href="${aml}">Política de prevenção e verificação</a></dd></div>
    <div><dt>Taxas</dt><dd><a href="${fees}">Tabela geral de fees</a></dd></div>
    <div><dt>Execução</dt><dd><a href="${execution}">Política de execução de ordens</a></dd></div>
    <div><dt>Pagamento</dt><dd><a href="${payment}">Política de pagamento</a></dd></div>
    <div><dt>Saque</dt><dd><a href="${withdrawal}">Política de retirada</a></dd></div>
    <div><dt>Risco</dt><dd><a href="${risk}">Aviso de risco</a></dd></div>
  </dl>
</aside>
<h2>O que clientes relatam</h2>
<ul>
  <li><strong>Saques</strong> — “Saque foi o que me fez continuar, caiu certinho e rápido.” <em>— Eduardo P.</em></li>
  <li><strong>Suporte</strong> — “Suporte respondeu rápido quando precisei, coisa rara hoje em dia.” <em>— Bruno T.</em></li>
  <li><strong>Plataforma</strong> — “Roda lisa até no meu PC lerdo.” <em>— Juliana A.</em></li>
  <li><strong>Estabilidade</strong> — “Tô usando há uns 6 meses, até agora só experiência boa.” <em>— Rafael M.</em></li>
</ul>
...
<h2>Conclusão</h2>
<p>Com base na documentação pública, no funcionamento da plataforma e no que os usuários relatam, a <a href="${home}">Shiver Broker</a> apresenta infraestrutura, payout competitivo e suporte que responde.</p>
<p>Como toda operação neste mercado, o risco é real e pede gestão de banca — e leitura das políticas — antes do primeiro depósito.</p>
`,
  "shiver-vip": `
<p class="post-lede">Você já ouviu falar no <strong>programa VIP da Shiver Broker</strong> e ficou curioso se realmente vale? Aqui estão as vantagens — e para quem esse nível faz diferença.</p>
...
<h3>A.I Financial™ na operação</h3>
...
<h3>Suporte gerenciado, sem fila geral</h3>
...
<h3>Saques com prioridade</h3>
<p>Limites e ritmo diferenciados, com processamento na frente de quem ainda está na fila geral.</p>
<h3>Cupons e condições exclusivas</h3>
<p>Campanhas, cupons e condições liberadas só para quem já performa nesse nível — o que não aparece no cadastro padrão.</p>
<h3>Premiações presenciais</h3>
<p>Eventos para quem já saiu da média: networking, premiações e o que o restante da plataforma ainda não mostra.</p>
<h3>Ativos e modalidades liberados</h3>
...
<aside class="post-note">
  ...
  <p>“Comecei com pouco e fui pegando confiança aos poucos, até agora tá valendo a pena, sou VIP e me dão bastante atenção.” <em>— Thiago M.</em></p>
</aside>
...
<aside class="post-note">
  <strong>Antes do próximo degrau</strong>
  <p>Quer sentir a plataforma primeiro? Abra a <a href="${trial}">conta demo com $10.000 virtuais</a> e veja o que a conta padrão já entrega — o VIP é o passo seguinte.</p>
</aside>
`,
  jornada: `
<p class="post-lede">Este é o guia para quem está começando do zero na <a href="${home}">Shiver Broker</a>: do cadastro ao primeiro saque, com o que fazer em cada fase.</p>
...
<aside class="post-note">
  ...
  <ul>
    <li>Cadastro feito</li>
    <li>E-mail confirmado</li>
    <li>Primeiro acesso à plataforma</li>
    <li>Demo com $10.000 virtuais ativa</li>
  </ul>
</aside>
